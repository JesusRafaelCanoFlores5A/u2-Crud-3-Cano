...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.id_producto, p.nombre_producto,p.precio, pv.cantidad
FROM productos p
INNER JOIN 
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->nombre_producto;  ?> <strong>$<?php echo number_format($producto->precio, 2) ?></strong></td>
